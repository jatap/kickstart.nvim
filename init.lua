-- Minimal Neovim configuration: core settings, keymaps, and the Modus theme.
-- No plugin manager, no packages — except the Modus theme, which is installed
-- as a native pack so it loads automatically:
--
